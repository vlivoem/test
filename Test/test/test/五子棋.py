...
# 使用chessman命名元组表示执棋方
# namedtuple定义方式：collections.namedtuple(typename, field_names, *, verbose=False, rename=False, module=None)  typename：元组名字，field_names：元组内容
Chessman = namedtuple('Chessman', 'Name Value Color')
# 使用point命名元组表示落子点
Point = namedtuple('Point', 'X Y')

# 定义执棋方 元组内容分别为：name，value，color
...
class Checkerboard:
    ...
    # property() 函数和 @property 装饰器，使用“对象.属性”的方式操作操作类属性
